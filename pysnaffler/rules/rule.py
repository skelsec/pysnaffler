...
class SnaffleRule:
    def __init__(self, enumerationScope, RuleName, matchAction, relayTargets, description, matchLocation, wordListType,
                 matchLength, wordList, triage) -> None:
    ...
    def from_dict(datadict: Dict):
        ...
        for d in datadict['ClassifierRules']:
            ...
            results.append(
                obj(enumerationScope, ruleName, matchAction, relayTargets, description, matchLocation, wordListType,
                    matchLength, wordList, triage))
        return results
